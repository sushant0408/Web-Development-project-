<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r5' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 19.0436617, lng: 72.8172225};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                ...
                <br>
                <img src="my3.jpg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 4000 for two people (approx) without alcohol</p>
                                <p>- Rs. 375 (approx) for a pint of beer</p>
                                <br>
                                <h3>Top Dishes</h3>
                                <p>-Dumplings, Fortune Cookie, Chocolate Mousse Cake,Hakka Noodles, Cocktails, Ming Yang Chicken</p>
                            </div>
                            <div class="columnn" >
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_1"><img src="my2.jpg"></a></li>
                            <li><a href="#img_2"><img src="my1.jpg"></a></li>
                            <li><a href="#img_3"><img src="my3.jpg"></a></li>
                            <li><a href="#img_4"><img src="my8.jpeg"></a></li>
                            <li><a href="#img_5"><img src="my4.jpg"></a></li>
                            <li><a href="#img_6"><img src="my5.jpg"></a></li>
                            <li><a href="#img_7"><img src="my6.jpg"></a></li>
                            <li><a href="#img_8"><img src="my7.jpg"></a></li>
                            
                            
                        </ul>
                            <a href="#_1" class="lightbox trans" id="img_1"><img src="my2.jpg"></a>
                            <a href="#_2" class="lightbox trans" id="img_2"><img src="my1.jpg"></a>
                            <a href="#_3" class="lightbox trans" id="img_3"><img src="my3.jpg"></a>
                            <a href="#_4" class="lightbox trans" id="img_4"><img src="my8.jpeg"></a>
                            <a href="#_5" class="lightbox trans" id="img_5"><img src="my4.jpg"></a>
                            <a href="#_6" class="lightbox trans" id="img_6"><img src="my5.jpg"></a>
                            <a href="#_7" class="lightbox trans" id="img_7"><img src="my6.jpg"></a>
                            <a href="#_8" class="lightbox trans" id="img_8"><img src="my7.jpg"></a>
                ...
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_111"><img src="mym1.jpg"></a></li>
                            <li><a href="#img_22"><img src="mym2.jpg"></a></li>
                            <li><a href="#img_33"><img src="mym3.jpg"></a></li>
                            <li><a href="#img_44"><img src="mym4.jpg"></a></li>
                           
                           
                        </ul>
                          <a href="#_111" class="lightbox trans" id="img_111"><img src="mym1.jpg"></a>
                          <a href="#_22" class="lightbox trans" id="img_22"><img src="mym2.jpg"></a>
                          <a href="#_33" class="lightbox trans" id="img_33"><img src="mym3.jpg"></a>
                          <a href="#_44" class="lightbox trans" id="img_44"><img src="mym4.jpg"></a>
                ...
                <div id="Reviews" class="tabcontent"> 
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r5" name="rid"/>
                    <br>
