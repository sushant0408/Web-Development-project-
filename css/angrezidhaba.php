<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r9' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 19.0106276, lng: 72.8266942};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                <h1>Angrezi Dhaba</h1>
                <h4 style="margin-left: 40px;"">Central</h4>
                <br>
                <img src="ad3.jpg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 1500 for two people (approx.)without alcohol</p>
                                <p>- Rs. 99 for a pint of beer (approx.)</p>
                                <br>
                                <h3>Top Dishes</h3>
                                <p>- Cocktails,Mocktails,Brownie,Naan,Butter Chicken,choclate overload</p>
                            </div>
                            <div class="columnn" >
                                ...
                                <ul>
                                    ...
                                    <li>Free Wifi<span class="fa fa-close red"></li>
                                    <li>Home delivery<span class="fa fa-close red"></li>
                                    <li>Smoking area<span class="fa fa-check red"></span></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <div class="top">
                      <ul>
                          <li><a href="#img_1"><img src="ad2.jpg"></a></li>
                          <li><a href="#img_2"><img src="ad4.jpg"></a></li>
                          <li><a href="#img_3"><img src="ad5.jpg"></a></li>
                          <li><a href="#img_4"><img src="ad6.jpg"></a></li>
                          <li><a href="#img_5"><img src="ad7.jpg"></a></li>
                          <li><a href="#img_6"><img src="ad8.jpg"></a></li>
                          <li><a href="#img_7"><img src="ad1.jpg"></a></li>
                          <li><a href="#img_8"><img src="ad9.jpg"></a></li>
                          <li><a href="#img_9"><img src="ad14.jpg"></a></li>
                          <li><a href="#img_10"><img src="ad10.jpg"></a></li>
                          <li><a href="#img_11"><img src="ad11.jpg"></a></li>
                          <li><a href="#img_12"><img src="ad12.jpg"></a></li>
                      </ul>
                          <a href="#_1" class="lightbox trans" id="img_1"><img src="ad2.jpg"></a>
                          <a href="#_2" class="lightbox trans" id="img_2"><img src="ad4.jpg"></a>
                          <a href="#_3" class="lightbox trans" id="img_3"><img src="ad5.jpg"></a>
                          <a href="#_4" class="lightbox trans" id="img_4"><img src="ad6.jpg"></a>
                          <a href="#_5" class="lightbox trans" id="img_5"><img src="ad7.jpg"></a>
                          <a href="#_6" class="lightbox trans" id="img_6"><img src="ad8.jpg"></a>
                          <a href="#_7" class="lightbox trans" id="img_7"><img src="ad1.jpg"></a>
                          <a href="#_8" class="lightbox trans" id="img_8"><img src="ad9.jpg"></a>
                          <a href="#_9" class="lightbox trans" id="img_8"><img src="ad14.jpg"></a>
                          <a href="#_10" class="lightbox trans" id="img_8"><img src="ad10.jpg"></a>
                          <a href="#_11" class="lightbox trans" id="img_8"><img src="ad11.jpg"></a>
                          <a href="#_12" class="lightbox trans" id="img_8"><img src="ad12.jpg"></a>
                      </div>
                </div>
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                      <ul>
                          <li><a href="#img_111"><img src="adm1.jpg"></a></li>
                          <li><a href="#img_22"><img src="adm2.jpg"></a></li>
                          <li><a href="#img_33"><img src="adm3.jpg"></a></li>
                          <li><a href="#img_44"><img src="adm4.jpg"></a></li>
                          <li><a href="#img_55"><img src="adm9.jpg"></a></li>
                          <li><a href="#img_66"><img src="adm10.jpg"></a></li>
                          <li><a href="#img_77"><img src="adm11.jpg"></a></li>
                          <li><a href="#img_88"><img src="adm12.jpg"></a></li>

                      </ul>
                        <a href="#_111" class="lightbox trans" id="img_111"><img src="adm1.jpg"></a>
                        <a href="#_22" class="lightbox trans" id="img_22"><img src="adm2.jpg"></a>
                        <a href="#_33" class="lightbox trans" id="img_33"><img src="adm3.jpg"></a>
                        <a href="#_44" class="lightbox trans" id="img_44"><img src="adm4.jpg"></a>
                        <a href="#_55" class="lightbox trans" id="img_55"><img src="adm9.jpg"></a>
                        <a href="#_66" class="lightbox trans" id="img_66"><img src="adm10.jpg"></a>
                        <a href="#_77" class="lightbox trans" id="img_77"><img src="adm11.jpg"></a>
                        <a href="#_88" class="lightbox trans" id="img_88"><img src="adm12.jpg"></a>
                    </div>
                ...
                <div id="Reviews" class="tabcontent">
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r9" name="rid"/>
                    <br>
