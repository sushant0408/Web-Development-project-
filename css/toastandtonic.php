<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r6' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 19.05936, lng: 72.8625343};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                <h1>Toast and Tonic</h1>
                <h4 style="margin-left: 40px;"">Western</h4>
                <br>
                <img src="tnt5.jpg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 1700 for two people (approx) without alcohol</p>
                                <p>- Rs. 220 (approx) for a pint of beer</p>
                                <br>
                                <h3>Top Dishes</h3>
                                <p>- Cocktails, Truffle, Fries, Nachos, Fish, Risotto, Spaghetti, Shrimp</p>
                            </div>
                            <div class="columnn" >
                                <h3>Other Information</h3>
                                <ul>
                                    <li>Live Sport Screening<span class="fa fa-close red"></li>
                                    <li>Full Bar<span class="fa fa-check green"></span></li>
                                    <li>Seatings<span class="fa fa-check green"></span></li>
                                    <li>Valet Parking<span class="fa fa-check green"></li>
                                    ...
                                    <li>Table Reservation Required<span class="fa fa-check green"></li>
                                    <li>Keto Options<span class="fa fa-check green"></li>
                                    <li>Smoking area<span class="fa fa-close red"></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <br>
                    <br>
                    <h3 class="talign">A Photographic Story</h3>
                    <br>
                    <div class="top">
                        <ul>
                            <li><a href="#img_1"><img src="tnt2.jpg"></a></li>
                            <li><a href="#img_2"><img src="tnt1.jpg"></a></li>
                            <li><a href="#img_3"><img src="tnt3.jpg"></a></li>
                            <li><a href="#img_4"><img src="tnt8.jpg"></a></li>
                            <li><a href="#img_5"><img src="tnt4.jpg"></a></li>
                            <li><a href="#img_6"><img src="tnt5.jpg"></a></li>
                            <li><a href="#img_7"><img src="tnt6.png"></a></li>
                            <li><a href="#img_8"><img src="tnt7.jpg"></a></li>
                            <li><a href="#img_9"><img src="kc9.jpg"></a></li>
                            <li><a href="#img_10"><img src="tnt10.jpg"></a></li>
                            <li><a href="#img_11"><img src="tnt11.jpeg"></a></li>
                            <li><a href="#img_12"><img src="tnt12.jpg"></a></li>
                            
                        </ul>
                            <a href="#_1" class="lightbox trans" id="img_1"><img src="tnt2.jpg"></a>
                            <a href="#_2" class="lightbox trans" id="img_2"><img src="tnt1.jpg"></a>
                            <a href="#_3" class="lightbox trans" id="img_3"><img src="tnt3.jpg"></a>
                            <a href="#_4" class="lightbox trans" id="img_4"><img src="tnt8.jpg"></a>
                            <a href="#_5" class="lightbox trans" id="img_5"><img src="tnt4.jpg"></a>
                            <a href="#_6" class="lightbox trans" id="img_6"><img src="tnt5.jpg"></a>
                            <a href="#_7" class="lightbox trans" id="img_7"><img src="tnt6.png"></a>
                            <a href="#_8" class="lightbox trans" id="img_8"><img src="tnt7.jpg"></a>
                            <a href="#_9" class="lightbox trans" id="img_9"><img src="tnt9.jpg"></a>
                            <a href="#_10" class="lightbox trans" id="img_10"><img src="tnt10.jpg"></a>
                            <a href="#_11" class="lightbox trans" id="img_11"><img src="tnt11.jpeg"></a>
                            <a href="#_12" class="lightbox trans" id="img_12"><img src="tnt12.jpg"></a>
                ...
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_111"><img src="tntm1.jpg"></a></li>
                            <li><a href="#img_22"><img src="tntm2.jpg"></a></li>
                            <li><a href="#img_33"><img src="tntm3.jpg"></a></li>
                            <li><a href="#img_44"><img src="tntm4.jpg"></a></li>
                           
                           
                        </ul>
                          <a href="#_111" class="lightbox trans" id="img_111"><img src="tntm1.jpg"></a>
                          <a href="#_22" class="lightbox trans" id="img_22"><img src="tntm2.jpg"></a>
                          <a href="#_33" class="lightbox trans" id="img_33"><img src="tntm3.jpg"></a>
                          <a href="#_44" class="lightbox trans" id="img_44"><img src="tntm4.jpg"></a>
                ...
                <div id="Reviews" class="tabcontent"> 
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r6" name="rid"/>
                    <br>
