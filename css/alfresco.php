<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r2' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 19.1887411, lng: 72.9016739};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                ...
                <br>
                <img src="af8.jpg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 600 for two people (approx) without alcohol</p>
                                
                                <br>
                                <h3>Top Dishes</h3>
                                <p>- Pasta, Burgers, Thin Crust Pizza, Sandwich</p>
                            </div>
                            <div class="columnn" >
                                ...
                                <ul>
                                    ...
                                    <li>No Alcohol Available<span class="fa fa-close red"></li>
                                    <li>Parking<span class="fa fa-check green"></li>
                                    <li>Smoking area<span class="fa fa-close red"></span></li>	
                                </ul>
                            </div>
                        </div>
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_1"><img src="af1.png"></a></li>
                            <li><a href="#img_2"><img src="af2.jpg"></a></li>
                            <li><a href="#img_3"><img src="af3.jpg"></a></li>
                            <li><a href="#img_4"><img src="af4.jpg"></a></li>
                            <li><a href="#img_5"><img src="af5.jpg"></a></li>
                            <li><a href="#img_6"><img src="af6.jpg"></a></li>
                            <li><a href="#img_7"><img src="af7.jpg"></a></li>
                            <li><a href="#img_8"><img src="af8.jpg"></a></li>
                            
                        </ul>
                            <a href="#_1" class="lightbox trans" id="img_1"><img src="af1.png"></a>
                            <a href="#_2" class="lightbox trans" id="img_2"><img src="af2.jpg"></a>
                            <a href="#_3" class="lightbox trans" id="img_3"><img src="af3.jpg"></a>
                            <a href="#_4" class="lightbox trans" id="img_4"><img src="af4.jpg"></a>
                            <a href="#_5" class="lightbox trans" id="img_5"><img src="af5.jpg"></a>
                            <a href="#_6" class="lightbox trans" id="img_6"><img src="af6.jpg"></a>
                            <a href="#_7" class="lightbox trans" id="img_7"><img src="af7.jpg"></a>
                            <a href="#_8" class="lightbox trans" id="img_8"><img src="af8.jpg"></a>
                ...
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_111"><img src="afm1.jpg"></a></li>
                            <li><a href="#img_22"><img src="afm2.jpg"></a></li>
                            <li><a href="#img_33"><img src="afm3.jpg"></a></li>
                            <li><a href="#img_44"><img src="afm4.jpg"></a></li>
                            
                        </ul>
                          <a href="#_111" class="lightbox trans" id="img_111"><img src="afm1.jpg"></a>
                          <a href="#_22" class="lightbox trans" id="img_22"><img src="afm2.jpg"></a>
                          <a href="#_33" class="lightbox trans" id="img_33"><img src="afm3.jpg"></a>
                          <a href="#_44" class="lightbox trans" id="img_44"><img src="afm4.jpg"></a>
                ...
                <div id="Reviews" class="tabcontent"> 
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r2" name="rid"/>
                    <br>
