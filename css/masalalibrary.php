<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r3' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 19.0691942, lng: 72.8676085};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                <h1>Masala Library</h1>
                <h4 style="margin-left: 40px;">Central</h4>
                <br>
                <img src="ml1.jpg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 5000 for two people (approx) without alcohol</p>
                                <p>- Rs. 300 (approx) for a pint of beer</p>
                                <br>
                                <h3>Top Dishes</h3>
                                <p>- Rabri, Jalebi, Butter Chicke, Dal Makhani, Rasmalai</p>
                            </div>
                            <div class="columnn" >
                                <h3>Other Information</h3>
                                <ul>
                                    <li>Wheel Chair Accessible<span class="fa fa-check green"></li>
                                    <li>Full Bar Available<span class="fa fa-check green"></span></li>
                                    <li>Table Reservation<span class="fa fa-check green"></span></li>
                                    <li>Vegetarian<span class="fa fa-check green"></li>
                                    <li>Non-vegetarian<span class="fa fa-close red"></li>
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_1"><img src="ml1.jpg"></a></li>
                            <li><a href="#img_2"><img src="ml2.jpg"></a></li>
                            <li><a href="#img_3"><img src="ml3.jpg"></a></li>
                            <li><a href="#img_4"><img src="ml4.jpg"></a></li>
                            <li><a href="#img_5"><img src="ml5.jpg"></a></li>
                            <li><a href="#img_6"><img src="ml6.jpg"></a></li>
                            <li><a href="#img_7"><img src="ml7.jpg"></a></li>
                            <li><a href="#img_8"><img src="ml8.jpg"></a></li>
                            
                           
                        </ul>
                            <a href="#_1" class="lightbox trans" id="img_1"><img src="ml1.jpg"></a>
                            <a href="#_2" class="lightbox trans" id="img_2"><img src="ml2.jpg"></a>
                            <a href="#_3" class="lightbox trans" id="img_3"><img src="ml3.jpg"></a>
                            <a href="#_4" class="lightbox trans" id="img_4"><img src="ml4.jpg"></a>
                            <a href="#_5" class="lightbox trans" id="img_5"><img src="ml5.jpg"></a>
                            <a href="#_6" class="lightbox trans" id="img_6"><img src="ml6.jpg"></a>
                            <a href="#_7" class="lightbox trans" id="img_7"><img src="ml7.jpg"></a>
                            <a href="#_8" class="lightbox trans" id="img_8"><img src="ml8.jpg"></a>
                ...
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_111"><img src="mlm2.jpg"></a></li>
                            <li><a href="#img_22"><img src="mlm3.jpg"></a></li>
                            <li><a href="#img_33"><img src="mlm4.jpg"></a></li>
                            <li><a href="#img_44"><img src="mlm5.jpg"></a></li>
                            
                           
                        </ul>
                          <a href="#_111" class="lightbox trans" id="img_111"><img src="mlm2.jpg"></a>
                          <a href="#_22" class="lightbox trans" id="img_22"><img src="mlm3.jpg"></a>
                          <a href="#_33" class="lightbox trans" id="img_33"><img src="mlm4.jpg"></a>
                          <a href="#_44" class="lightbox trans" id="img_44"><img src="mlm5.jpg"></a>
                ...
                <div id="Reviews" class="tabcontent"> 
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r3" name="rid"/>
                    <br>
