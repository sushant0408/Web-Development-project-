f<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r7' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 18.9290863, lng: 72.8321782};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                ...
                <br>
                <img src="pi9.jpeg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 800 for two people</p>
                                <p>- Rs. 245 for a pint of beer (approx.)</p>
                                <br>
                                <h3>Top Dishes</h3>
                                <p>- Gourment Pizza,Tiramisu,Choclate mouse,Paneer Tikka Pizza</p>
                            </div>
                            <div class="columnn" >
                                <h3>Other Information</h3>
                                <ul>
                                    <li>Live Sport Screening<span class="fa fa-close red"></li>
                                    <li>Full Bar<span class="fa fa-close red"></span></li>
                                    ...
                                    <li>Free Wifi<span class="fa fa-check green"></li>
                                    <li>Home delivery<span class="fa fa-check green"></li>
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <div class="top">
                      <ul>
                          <li><a href="#img_1"><img src="pi1.jpg"></a></li>
                          <li><a href="#img_2"><img src="pi2.jpg"></a></li>
                          <li><a href="#img_3"><img src="pi3.jpg"></a></li>
                          <li><a href="#img_4"><img src="pi4.jpg"></a></li>
                          <li><a href="#img_5"><img src="pi5.jpg"></a></li>
                          <li><a href="#img_6"><img src="pi7.jpg"></a></li>
                          <li><a href="#img_7"><img src="pi8.png"></a></li>
                          <li><a href="#img_8"><img src="pi6.jpg"></a></li>
                          <li><a href="#img_9"><img src="pi9.jpeg"></a></li>
                          <li><a href="#img_10"><img src="pi10.jpg"></a></li>
                          <li><a href="#img_11"><img src="pi11.jpg"></a></li>
                          <li><a href="#img_12"><img src="pi12.jpg"></a></li>
                      </ul>
                          <a href="#_1" class="lightbox trans" id="img_1"><img src="pi1.jpg"></a>
                          <a href="#_2" class="lightbox trans" id="img_2"><img src="pi2.jpg"></a>
                          <a href="#_3" class="lightbox trans" id="img_3"><img src="pi3.jpg"></a>
                          <a href="#_4" class="lightbox trans" id="img_4"><img src="pi4.jpg"></a>
                          <a href="#_5" class="lightbox trans" id="img_5"><img src="pi5.jpg"></a>
                          <a href="#_6" class="lightbox trans" id="img_6"><img src="pi7.jpg"></a>
                          <a href="#_7" class="lightbox trans" id="img_7"><img src="pi8.png"></a>
                          <a href="#_8" class="lightbox trans" id="img_8"><img src="pi6.jpg"></a>
                          <a href="#_9" class="lightbox trans" id="img_8"><img src="pi9.jpeg"></a>
                          <a href="#_10" class="lightbox trans" id="img_8"><img src="pi10.jpg"></a>
                          <a href="#_11" class="lightbox trans" id="img_8"><img src="pi11.jpg"></a>
                          <a href="#_12" class="lightbox trans" id="img_8"><img src="pi12.jpg"></a>
                      </div>
                </div>
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                      <ul>
                          <li><a href="#img_111"><img src="pim1.jpg"></a></li>
                          <li><a href="#img_22"><img src="pim2.jpg"></a></li>
                          <li><a href="#img_33"><img src="pim3.jpg"></a></li>
                          <li><a href="#img_44"><img src="pim5.jpg"></a></li>

                      </ul>
                        <a href="#_111" class="lightbox trans" id="img_111"><img src="pim1.jpg"></a>
                        <a href="#_22" class="lightbox trans" id="img_22"><img src="pim2.jpg"></a>
                        <a href="#_33" class="lightbox trans" id="img_33"><img src="pim3.jpg"></a>
                        <a href="#_44" class="lightbox trans" id="img_44"><img src="pim4.jpg"></a>
                    </div>
                ...
                <div id="Reviews" class="tabcontent">
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r7" name="rid"/>
                    <br>
