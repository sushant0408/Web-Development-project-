<?php
  ...
  $sql = "SELECT username,review FROM reviewss where rid='r1' ";
      ...
      document.getElementById("reve").innerHTML = '<tr><td>'+res[0]+'</td><td>'+res[1]+'<br>'+'</td></tr>'+'<tr><td>'+res[2]+'</td><td>'+res[3]+'</td></tr>'+'<tr><td>'+res[4]+'</td><td>'+res[5]+'<br>'+'</td></tr>'+'<tr><td>'+res[6]+'</td><td>'+res[7]+'<br>'+'</td></tr>'+'<tr><td>'+res[8]+'</td><td>'+res[9]+'<br>'+'</td></tr>'+'<tr><td>'+res[10]+'</td><td>'+res[11]+'<br>'+'</td></tr>';
        ...
        <script>
               ...
               function initMap() {
                 ...
                 var uluru = {lat: 19.1956565, lng: 72.9597745};
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1" id="roo">
                <h1>Kala Chashma</h1>
                <h4 style="margin-left: 40px;"">Suburban</h4>
                <br>
                <img src="kala.jpg" class="kala center" alt="kala">
                <br>
                <br>
                <div class="tab">
                ...
                <div id="About" class="tabcontent">
                    ...
                    <div class="abt">
                        <div class="roww">
                            <div class="columnn" >
                                <h3>Average Cost</h3>
                                <p>- Rs. 1200 for two people (approx) without alcohol</p>
                                <p>- Rs. 190 (approx) for a pint of beer</p>
                                <br>
                                <h3>Top Dishes</h3>
                                <p>- Mocktails, Cocktails, Fries, Nachos, Butter Chicken,Hazelnut cheesecake,Naan</p>
                            </div>
                            <div class="columnn" >
                                ...
                                <ul>
                                    ...
                                    <li>Dance floor<span class="fa fa-close red"></li>
                                    <li>Parking<span class="fa fa-check green"></li>
                ...
                <div id="Photos" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_1"><img src="kc2.jpg"></a></li>
                            <li><a href="#img_2"><img src="kc1.jpg"></a></li>
                            <li><a href="#img_3"><img src="kc3.jpg"></a></li>
                            <li><a href="#img_4"><img src="kc8.jpg"></a></li>
                            <li><a href="#img_5"><img src="kc4.jpg"></a></li>
                            <li><a href="#img_6"><img src="kc5.jpg"></a></li>
                            <li><a href="#img_7"><img src="kc6.jpg"></a></li>
                            <li><a href="#img_8"><img src="kc7.jpg"></a></li>
                            <li><a href="#img_9"><img src="kc9.jpg"></a></li>
                            <li><a href="#img_10"><img src="kc10.jpg"></a></li>
                            <li><a href="#img_11"><img src="kc11.jpg"></a></li>
                            <li><a href="#img_12"><img src="kc12.jpg"></a></li>
                            <li><a href="#img_13"><img src="kc13.jpg"></a></li>
                            <li><a href="#img_14"><img src="kc14.jpg"></a></li>
                            <li><a href="#img_15"><img src="kc15.jpg"></a></li>
                            <li><a href="#img_16"><img src="https://image.freepik.com/free-photo/from-blue-to-brown_426-19320820.jpg"></a></li>
                        </ul>
                            <a href="#_1" class="lightbox trans" id="img_1"><img src="kc2.jpg"></a>
                            <a href="#_2" class="lightbox trans" id="img_2"><img src="kc1.jpg"></a>
                            <a href="#_3" class="lightbox trans" id="img_3"><img src="kc3.jpg"></a>
                            <a href="#_4" class="lightbox trans" id="img_4"><img src="kc8.jpg"></a>
                            <a href="#_5" class="lightbox trans" id="img_5"><img src="kc4.jpg"></a>
                            <a href="#_6" class="lightbox trans" id="img_6"><img src="kc5.jpg"></a>
                            <a href="#_7" class="lightbox trans" id="img_7"><img src="kc6.jpg"></a>
                            <a href="#_8" class="lightbox trans" id="img_8"><img src="kc7.jpg"></a>
                            <a href="#_9" class="lightbox trans" id="img_9"><img src="kc9.jpg"></a>
                            <a href="#_10" class="lightbox trans" id="img_10"><img src="kc10.jpg"></a>
                            <a href="#_11" class="lightbox trans" id="img_11"><img src="kc11.jpg"></a>
                            <a href="#_12" class="lightbox trans" id="img_12"><img src="kc12.jpg"></a>
                            <a href="#_13" class="lightbox trans" id="img_13"><img src="kc13.jpg"></a>
                            <a href="#_14" class="lightbox trans" id="img_14"><img src="kc14.jpg"></a>
                            <a href="#_15" class="lightbox trans" id="img_15"><img src="kc15.jpg"></a>
                ...
                <div id="Menu" class="tabcontent">
                    ...
                    <div class="top">
                        <ul>
                            <li><a href="#img_111"><img src="kc111.jpg"></a></li>
                            <li><a href="#img_22"><img src="kc22.jpg"></a></li>
                            <li><a href="#img_33"><img src="kc33.jpg"></a></li>
                            <li><a href="#img_44"><img src="kc44.jpg"></a></li>
                            <li><a href="#img_55"><img src="kc55.jpg"></a></li>
                            <li><a href="#img_66"><img src="kc66.jpg"></a></li>
                            <li><a href="#img_77"><img src="kc77.jpg"></a></li>
                            <li><a href="#img_88"><img src="https://image.freepik.com/free-photo/from-blue-to-brown_426-19320820.jpg"></a></li>
                        </ul>
                          <a href="#_111" class="lightbox trans" id="img_111"><img src="kc111.jpg"></a>
                          <a href="#_22" class="lightbox trans" id="img_22"><img src="kc22.jpg"></a>
                          <a href="#_33" class="lightbox trans" id="img_33"><img src="kc33.jpg"></a>
                          <a href="#_44" class="lightbox trans" id="img_44"><img src="kc44.jpg"></a>
                          <a href="#_55" class="lightbox trans" id="img_55"><img src="kc55.jpg"></a>
                          <a href="#_66" class="lightbox trans" id="img_66"><img src="kc66.jpg"></a>
                          <a href="#_77" class="lightbox trans" id="img_77"><img src="kc77.jpg"></a>
                          <a href="#_88" class="lightbox trans" id="img_88"><img src="https://image.freepik.com/free-photo/from-blue-to-brown_426-19320820.jpg"></a>
                    </div>
                ...
                <div id="Reviews" class="tabcontent"> 
                    ...
                    <form action="daalo.php" method="post">
                        ...
                        <input type="hidden" value="r1" name="rid"/>
                    <br>
